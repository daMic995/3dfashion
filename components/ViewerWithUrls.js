    ...
    useEffect(() => {
        if (url && loadModel) {
            ...
            if (viewerRef.current === null) {
                ...
                // To load a file into the viewer using the url, we first pass a file name, 
                // OV.FileSource.Url and then the url of the model to the OV.InputFile constructor, 
                // put the newly created object in an array and save it as inputFiles
                let inputFiles = [
